...
There is no missing data on the datasets.
...
There are 2.470 rows are duplicated in application.checkpoint data. We should consider in our analysis. In gpu dataframe , there are only 9 rows duplicated. However, task.x.y dataframe does not contain duplicate rows.
